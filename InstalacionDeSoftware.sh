...
software="which git diff ping figlet nano gdebi curl konsole popo" #ponemos el foftware a instalar separado por espacion dentro de las comillas ( soft1 soft2 soft3 etc )
