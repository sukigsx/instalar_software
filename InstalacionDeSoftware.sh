...
export version="1.7 se añade navegador opera por repositorios"
...
software="which git diff ping figlet nano gdebi curl konsole wget fzf" #ponemos el foftware a instalar separado por espacion dentro de las comillas ( soft1 soft2 soft3 etc )
